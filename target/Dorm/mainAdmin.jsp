...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/bootstrap/css/dataTables.bootstra.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/bootstrap/js/jQuery.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/bootstrap/js/jquery.dataTables.js"></script>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		...
		<div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<span style="color: red">${currentUser.userName }</span></div>
	</div>
</div>
