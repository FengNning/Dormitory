...
<div class="data_list">
		...
		<form action="student?action=save" method="post" onsubmit="return checkForm()">
			<div class="data_form" >
				<input type="hidden" id="studentId1" name="studentId" value="${student.studentId }"/>
					<table align="center">
						<tr>
							<td><font color="red">*</font>学号：</td>
							<td><input type="text" id="studentId"  name="studentId" value="${student.studentId }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" id="stuName"  name="stuName" value="${student.stuName }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" id="dormName"  name="dormId" value="${student.dormId }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
